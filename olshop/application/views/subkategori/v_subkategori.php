<div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <a href="<?= base_url('sub_kategori/add') ?>" type="button" class="btn btn-primary btn-sm" >
...
<!-- <?php foreach ($sub_kategori as $key => $value) { ?>
 ...
 <?php foreach ($sub_kategori as $key => $value) { ?>
 <div class="modal fade" id="delete<?= $value->id_subkategori ?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete <?= $value->nama_subkategori ?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <a href="<?= base_url('sub_kategori/delete/' . $value->id_barang) ?>" class="btn btn-primary">Delete</a>
            </div>
