...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Edit Produk/Barang</h3>
              </div>
              <!-- /.card-header -->
            <div class="card-body">
            ...
            <!-- /.sub_kategori --> 
                  <div class="col-sm-6">
                      <div class="form-group">
                       ...
                       <option value="<?= $barang->id_subkategori?>"><?= $barang->nama_subkategori ?></option>
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                       ...
                       <option value="<?= $barang->id_class?>"><?= $barang->nama_class ?></option>
                ...
                <div class="form-group">
                        ...
                        <input name="stok" class="form-control" placeholder="Stok Produk" 
                        value="<?= $barang->stok?>">
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                        <div class="form-group">
                        <img src="<?= base_url('assets/gambar/'. $barang->gambar) ?>" id="gambar_nodin" width="400" alt="Preview Gambar"  />
                        </div>
                  </div>
