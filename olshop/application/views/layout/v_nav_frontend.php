<nav class="main-header navbar navbar-expand-md navbar-dark navbar-navy">
  <div class="container">
    <a href="<?= base_url() ?>" class="navbar-brand">
      <img src="<?= base_url() ?>assets/slider/splus.jpg" alt="splus" class="brand-image img-circle elevation-3" style="opacity: .8">
      PasarInterior</span>
    </a>
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <a href="<?= base_url() ?>" class="nav-link "><b>Tentang S-Plus</b></a>
        </li>
        <li class="nav-item ">
          <a href="<?= base_url() ?>" class="nav-link "><b>Produk S-Plus</b></a>
        </li>
    ...
    <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="dropdown" href="<?= base_url('admin') ?>">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?= base_url('auth/login_user') ?>" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> Log-in
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container">
      <div class="row mb-1">
        <div class="col-sm-6">
          <!-- <h4 class="m-0"> <b><?= $title ?></b></h4>   -->
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <!-- <li class="breadcrumb-item"><a href="#">PasarInterior</a></li>
